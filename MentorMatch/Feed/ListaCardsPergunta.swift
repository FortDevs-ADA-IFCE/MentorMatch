...
struct ListaCardsPergunta: View {
    @State var perguntas: [CardPergunta] = [
        ...
        CardPergunta(categoria: .português, autor: "Guilherme", texto: "Qual a conjugação do verbo 'agir'?", data: Date.now),
        CardPergunta(categoria: .matemática, autor: "Melissa", texto: "Como se calcula uma integral?", data: Date.now),
        CardPergunta(categoria: .história, autor: "Rafael", texto: "Quem descobriu o Brasil? ", data: Date.now),
